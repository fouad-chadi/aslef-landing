    ...
    <div id="top" className="relative overflow-hidden bg-[var(--color-bg-soft)]">
      ...
      <Container className="relative pt-14 pb-16 sm:pt-20 sm:pb-20 lg:pt-24 lg:pb-24">
        ...
        <motion.div
          ...
          className="mt-14 grid grid-cols-1 gap-6 rounded-[1.75rem] border border-[var(--color-border)] bg-white p-6 shadow-[var(--shadow-card)] sm:p-8 lg:grid-cols-4 lg:gap-8"
        >
          {strip.map((item) => (
