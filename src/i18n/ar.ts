...
const ar: Record<TranslationKey, string> = {
  ...
  'faq.a8': 'حمّلوا التطبيق مباشرة من هذا الموقع، ثم سجّلوا الدخول بالمعلومات التي تسلّمها لكم حضانتكم. لأي استفسار، لا تترددوا في التواصل معنا.',
  ...
  // Registration
  'register.badge': 'التسجيل',
  'register.headline': 'أنشئ حضانتك على أصلاف.',
  'register.sub': 'املأ هذا النموذج، سنتواصل معك سريعاً عبر واتساب لإتمام التسجيل.',
  'register.field.firstName': 'الاسم الشخصي',
  'register.field.lastName': 'اللقب',
  'register.field.crecheName': 'اسم الحضانة',
  'register.field.crechePhone': 'هاتف الحضانة',
  'register.field.wilaya': 'الولاية',
  'register.field.wilaya.optional': '(اختياري)',
  'register.field.capacity': 'السعة',
  'register.field.capacity.help': 'العدد الأقصى لحسابات الأولياء',
  'register.field.access': 'الوصول',
  'register.field.access.help': 'عدد حسابات الإدارة/المربيات المشمولة',
  'register.capacity.suffix': 'حساب ولي',
  'register.access.suffix': 'وصول',
  'register.subscription.title': 'اشتراكك',
  'register.subscription.badge': 'اشتراك ثلاثي الأشهر',
  'register.pricing.parent.title': 'سعر الحساب الواحد (وصولان مشمولان)',
  'register.pricing.perQuarter': 'دج / 3 أشهر',
  'register.pricing.extraChild.title': 'طفل إضافي (لكل حساب)',
  'register.pricing.extraChild.value': '+500 دج / 3 أشهر',
  'register.pricing.access.title': 'وصول موسّع (4 وصول)',
  'register.pricing.perAccount.title': 'سعر الحساب',
